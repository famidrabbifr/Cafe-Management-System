...
{
    public partial class Cus_Update_info: Form
    {
        private string uname;
        public Cus_Update_info(string USER_NAME)
        {
            InitializeComponent();
            uname = USER_NAME;
        ...
        private void Cus_Update_info_Load(object sender, EventArgs e)
        {
        ...
        private void btn_cus_update_info_back_Click(object sender, EventArgs e)
        {
